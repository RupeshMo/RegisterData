...
<div class="flex justify-center items-center h-screen bg-gray-100">
    <div class="flex w-full max-w-[1100px] h-[420px] bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105">
        ...
        <div class="flex flex-col justify-center p-8 w-full lg:w-1/2">
        ...
        <div class="relative  w-full lg:w-1/2">
            <div class="absolute container top-0 left-0 w-full h-full bg-pattern8 z-[-1] rounded-r-lg"></div> <!-- Abstract Pattern -->
        </div>
    </div>
</div>
